...
var imageSources = [
    ...
    // Add as many images as you need to preload
  ];
...
let rangevalue = document.getElementById("myRange");
        ...
        rangevalue.oninput = function() {
            ...
            preloadImages("rangevalue");
        if (getvalue > 0 && getvalue < 3) {              
            imgchangevalue.setAttribute("src",(imageSources[0]))
        } else if (getvalue >= 4 && getvalue <= 7) {
            imgchangevalue.setAttribute("src", (imageSources[1]))
        } else if (getvalue >= 8 && getvalue <= 11) {
            imgchangevalue.setAttribute("src",  (imageSources[2]))
        } else if (getvalue >= 12 && getvalue <= 15) {
            imgchangevalue.setAttribute("src",  (imageSources[3]))
        } else if (getvalue >= 16 && getvalue <= 19) {
            imgchangevalue.setAttribute("src", (imageSources[4]))
        } else if (getvalue >= 20 && getvalue <= 23) {
            imgchangevalue.setAttribute("src",  (imageSources[5]))
            ...
            imgchangevalue.setAttribute("src", "img/range-slider/earth_66m_years.png")
        } else if (getvalue >= 84 && getvalue <= 87) {
            imgchangevalue.setAttribute("src", "img/range-slider/earth_50m_years.png")
        } else if (getvalue >= 88 && getvalue <= 91) {
            imgchangevalue.setAttribute("src", "img/range-slider/earth_35m_years.png")
        } else if (getvalue >= 92 && getvalue <= 95) {
            imgchangevalue.setAttribute("src", "img/range-slider/earth_20m_years.png")
        } else if (getvalue >= 100) {
            imgchangevalue.setAttribute("src", "img/range-slider/earth_0m_years.png")
        }
    }
